            ...
            <div id="content" class="col-sm-12">
                        ...
                        <div class="loginnow">
                            ...
                            <form method="POST" action ="../php/reg.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <i class="fa fa-user"></i><input type="text" name="firstname"  placeholder="FIRSTNAME" id="firstname" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <i class="fa fa-user"></i><input type="text" name="lastname"  placeholder="LASTNAME" id="lastname" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <i class="fa fa-file-text"></i><input type="text" name="Address"  placeholder="ADDRESS" id="address" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <i class="fa fa-envelope"></i><input type="email" name="Email"  placeholder="Email" id="email" class="form-control1" />
                                </div>
                                <!-- <div class="form-group"> 
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="fileupload" accept="image/*" size="70" id="fileupload"/>
                                ...
                                <div class="form-group">
                                    <i class="fa fa-volume-control-phone"></i><input type="text" name="mobile"  placeholder="Mobile" id="mobile" class="form-control" />
                                </div>
                                
                        
                               <div class="form-group">
                                    <i class="fa fa-key"></i><i class="fa fa-eye eye" aria-hidden="true"></i><input type="password" name="password" value="" placeholder="password" id="input-password" class="form-control" />
                                </div>
                                <div class="form-group">
                                    <i class="fa fa-key"></i><i class="fa fa-eye eye" aria-hidden="true"></i><input type="password" name="confirm" value="" placeholder="confirm password" id="input-confirm" class="form-control" />
                                </div>
