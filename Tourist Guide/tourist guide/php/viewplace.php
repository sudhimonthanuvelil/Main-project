...
<div class="row">
<?php
$sql = "SELECT * FROM `addplace_tbl` where Status='0'";
// print_r($sql);
// return;
...
<button type="submit" class="btn btn-default" name="View" id="view" action="">Book</button>
<?php
$sql1="SELECT * FROM `addplace_tbl` where Status='0'";
